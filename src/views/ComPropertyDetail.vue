  ...
  <div class="detail-wrapper" v-if="property">
    ...
    <div v-if="showBookingModal" class="modal-overlay">
      <div class="modal">
        ...
        <input type="date" v-model="endDate" :min="startDate || minStartDate" />
...
const confirmBooking = async () => {
  ...
  if (!startDate.value || !endDate.value) return alert('Укажите даты аренды')
  ...
  if (start.isBefore(now, 'day')) {
    return alert('Дата начала не может быть в прошлом')
  }
